...
_sndbit
        rrf	    tmp_sr, F	    ; Shift rightmost (less significant) bit into 'C'
	    call    ONEW_SENDB
...
recv_bits
        call    ONEW_RECVB	    ; Get one bit from bus
...
cfv_bitloop
        movlw   .35             ; LOW level period always precedes any bit
...
chk_read
        btfss   flags, ReadRq   ; Check if 'READ REQUEST' bit is set
